...
SECRET_KEY = 'django-insecure-+j6+z8c@k(b*+89q5s1fwxa=^@q-3kh%x^(ys#jbi4+n*%55@d'
...
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'x@gmail.com'  # Replace with actual Gmail account
# EMAIL_HOST_PASSWORD = 'xpassword'  # Replace with Gmail app-specific password
